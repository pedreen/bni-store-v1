...
Minicart.prototype = {
    ...
    init: function() {
        ...
        // bind remove event
        $j(this.selectors.itemRemove).off('click.minicart').on('click.minicart', function(e) {
            e.preventDefault();
